...
export const TopMenu = () => {
    ...
    return (
        <nav className="flex ox-5 justify-between items-center w-full">
            <div>
                <Link
                    href="/">
                    <span className={`${titleFont.className} antialiased font-bold`}>Cakery</span>
                    <span> | Shop</span>
                </Link>
            </div>
            ...
            <div className="flex items-center">
                ...
                <Link href="/cart" className="mx-2">
                    <div className="relative">
                        <span className="absolute px-1 text-xs rounded-full px-1 font-bold -top-2 -right-2 bg-blue-700 text-white">
                            3
                        </span>
